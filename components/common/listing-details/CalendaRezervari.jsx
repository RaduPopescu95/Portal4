...
const CalendarRezervari = ({ specialistUid }) => {
  ...
  const handleReservationSubmit = async (reservationData) => {
    try {
      ...
      const domain = "https://www.connectify-hub.com";
      // const domain = "http://localhost:3000/";
      const linkConectareUtilizator = `${domain}/video-call?idConnect=${rezervareDocId}__${specialistUid}`;
      const linkConectareSpecialist = `${domain}/video-call-specialist?idConnect=${rezervareDocId}__${specialistUid}`;
